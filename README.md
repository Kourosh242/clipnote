...
**نسخهٔ ۱.۲.۶** | ساخته‌شده توسط **Kourosh & Nova**
...
## تغییرات مهم نسخه ۱.۲.۶

- اصلاح چیدمان **RTL** در صفحهٔ کامل مدیریت
- انتقال Sidebar / منوی کناری به **سمت راست** در زبان فارسی
- حفظ بدون تغییر رفتار Popup طبق درخواست
- بهبود **Export / Import JSON**
- خروجی JSON اکنون همهٔ داده‌های مهم شامل یادداشت‌ها، تنظیمات، دسته‌بندی‌ها، فضاهای کاری، برچسب‌های سفارشی و وضعیت آخرین Quick Save را در خود دارد
- ورود JSON اکنون داده‌های بکاپ را با داده‌های فعلی **ادغام** می‌کند و دیگر اطلاعات فعلی کاربر را پاک و جایگزین نمی‌کند
