...
(function () {
  ...
  const I18N = {
    en: {
      ...
      close: 'Close', copy: 'Copy', edit: 'Edit', delete: 'Delete', undo: 'Undo', cancel: 'Cancel', unlock: 'Unlock',
      editor: 'Editor', preview: 'Preview', unlockNote: 'Unlock Note', unlockHelp: 'Enter the password or PIN to unlock this note.',
      recoverPassword: 'Recover Password', recoveryQuestion: 'Recovery question', recoveryAnswer: 'Answer', recoveryUnavailable: 'No recovery question is set for this note.', recoveryFailed: 'Recovery answer is incorrect.', recoverySuccess: 'Recovery successful. You can now open the note.',
      passwordOrPin: 'Password or PIN', deleted: 'Deleted Successfully', saved: 'Saved Successfully', save: 'Save',
  ...
  const els = {
    ...
    recoveryPanel: document.getElementById('popup-recovery-panel'),
    recoveryQuestion: document.getElementById('popup-recovery-question'),
    recoveryAnswer: document.getElementById('popup-recovery-answer'),
    btnCancelUnlock: document.getElementById('btn-popup-cancel-unlock'),
    btnRecoverUnlock: document.getElementById('btn-popup-recover'),
    ...
    noteViewPanel: document.getElementById('popup-note-view-panel'),
    noteViewBadges: document.getElementById('popup-note-view-badges'),
    noteViewContent: document.getElementById('popup-note-view-content'),
    noteEditPanel: document.getElementById('popup-note-edit-panel'),
    ...
    btnStartEdit: document.getElementById('btn-popup-start-edit'),
  ...
  function applyLocale() {
    ...
    els.recoveryAnswer.placeholder = t('recoveryAnswer');
    ...
    if (els.btnStartEdit) els.btnStartEdit.textContent = t('edit');
  ...
  function setupEventListeners() {
    ...
    els.recoveryAnswer.addEventListener('keydown', (e) => {
  ...
  function openUnlockModal(note, callback = null) {
    ...
    els.recoveryQuestion.textContent = hasRecoveryQuestion(note) ? note.lock.recovery.question : t('recoveryUnavailable');
    els.recoveryPanel.classList.add('cn-hidden');
  ...
  async function handleRecoveryUnlock() {
    ...
    if (els.recoveryPanel.classList.contains('cn-hidden')) {
      unlockRecoveryMode = true;
      els.recoveryPanel.classList.remove('cn-hidden');
  ...
  function setPopupNoteMode(mode) {
    popupNoteMode = mode;
    const editMode = mode === 'edit';
    els.noteViewPanel.classList.toggle('cn-hidden', editMode);
    els.noteEditPanel.classList.toggle('cn-hidden', !editMode);
    els.btnStartEdit.classList.toggle('cn-hidden', editMode);
    els.btnNoteUndo.classList.toggle('cn-hidden', !editMode);
    els.btnSaveNote.classList.toggle('cn-hidden', !editMode);
    if (editMode) {
