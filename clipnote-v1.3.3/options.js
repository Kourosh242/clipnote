...
(function () {
  ...
  function applyLocale() {
    ...
    if (els.versionStatusValue) els.versionStatusValue.textContent = `v${chrome.runtime.getManifest().version || '1.3.3'}`;
    ...
    if (els.aboutVersion) {
      els.aboutVersion.textContent = 'v' + (chrome.runtime.getManifest().version || '1.3.3');
    }
  ...
  async function refreshVersionStatus() {
    ...
    try {
      ...
      const version = chrome.runtime.getManifest().version || '1.3.3';
